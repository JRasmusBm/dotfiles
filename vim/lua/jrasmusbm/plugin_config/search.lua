...
mappings.nmap(
  "<leader>eo",
  "<cmd>lua require('jrasmusbm.telescope.find_files').find_files({ prompt_title = 'Other Config Files', cwd = vim.fn.getenv('DOTFILES') .. '/vim/lua/jrasmusbm/other_config/' })<CR>",
  { noremap = true }
)
mappings.nmap(
  "<leader>et",
