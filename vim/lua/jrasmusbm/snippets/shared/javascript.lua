...
return {
  ...
  s({trig = "el", name = "event listener"},
    fmt("{}.eventListener(\"{}\", {})\n{}", {i(1), i(2), i(3), i(0)})),
  s({trig = "ef", name = "fire event"},
  ...
  s({trig = "wb", name = "witchcraft button"}, fmt(
  ...
  s({trig = "fa", name = "arrow function"},
    fmt("const {} = ({}) => {{\n  return ({})\n}}\n\n{}",
        {i(1), i(2), i(3, "null"), i(0)})),

  s({trig = "st", name = "set timeout"}, fmt(
      "setTimeout(() => {{\n  {}\n}}, {})\n\n{}", {i(1), i(2, "1000"), i(0)})),
  s({trig = "si", name = "set interval"}, fmt(
      "setInterval(() => {{\n  {}\n}}, {})\n\n{}", {i(1), i(2, "1000"), i(0)})),

  s({trig = "qt", name = "gql tag"},
    fmt("const {} = gql```\n{}\n```\n\n{}", {i(1), i(2), i(0)})),
  s({trig = "qr", name = "graphql resolver"},
    fmt("const {} = async ({}, {}, {}, {}) => {{\n  return ({})\n}}", {
    i(1),
    i(2, "_parent"),
    i(3, "_args"),
  ...
  s({trig = "ci", name = "if statement"},
    fmt("if ({}) {{\n  {}\n}}\n\n{}", {i(1), i(2), i(0)})),
  s({trig = "cei", name = "else if statement"},
    fmt("else if ({}) {{\n  {}\n}}\n\n{}", {i(1), i(2), i(0)})),
  s({trig = "ce", name = "else statement"},
    fmt("else {{\n  {}\n}}\n\n{}", {i(1), i(0)})),
  s({trig = "cw", name = "while statement"},
    fmt("if ({}) {{\n  {}\n}}\n\n{}", {i(1), i(2), i(0)})),
  s({trig = "ct", name = "try / catch"}, fmt(
      "try {{\n  {}\n}} catch {}{{\n  {}\n}}\n\n{}", {i(1), i(2), i(3), i(0)})),
  s({trig = "cs", name = "switch statement"},
    fmt("switch ({}) {{\n  case {}: {{\n    {}\n    break\n  }}\n  {}\n}}\n{}",
        {i(1), i(2), i(3), i(4), i(0)})),
  s({trig = "cc", name = "switch case"},
    fmt("case {}: {{\n  {}\n  break\n}}\n{}", {i(1), i(2), i(0)})),
  s({trig = "cd", name = "default case"},
    fmt("default: {{\n  {}\n}}", {i(0)})),
  s({trig = "cf", name = "for each"},
    fmt("for (const {} of {}) {{\n  {}\n}}\n\n{}", {i(1), i(2), i(3), i(0)})),
  s({trig = "cfr", name = "for range"},
    fmt("for (let {} = {}; {} < {}; {}{}) {{\n  {}\n}}\n\n{}",
