...
ls.snippets.lua = {
  ...
  s({trig = "i6", name = "four i(n)"},
    fmt("i(1)i i(2), i(3), i(4), i(5), i(0)", {})),
  s({trig = "i7", name = "four i(n)"},
    fmt("i(1)i i(2), i(3), i(4), i(5), i(6), i(0)", {})),
  s({trig = "i8", name = "four i(n)"},
    fmt("i(1)i i(2), i(3), i(4), i(5), i(6), i(7), i(0)", {})),
  s({trig = "i9", name = "four i(n)"},
