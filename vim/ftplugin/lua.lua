...
ls.snippets.lua = {
  ...
  s({trig = "fi", name = "function inline"},
    fmt("function {}({})\n  {}\nend\n\n{}", {i(1), i(2), i(3), i(0)})),
  s({trig = "fl", name = "local function"},
    fmt("local {} = function ({})\n  {}\nend\n\n{}", {i(1), i(2), i(3), i(0)})),
  s({trig = "fe", name = "local function"},
    fmt("M.{} = function ({})\n  {}\nend\n\n{}", {i(1), i(2), i(3), i(0)})),
  ...
  s({trig = "sn", name = "snippet"},
    fmt("s({{ trig=\"{}\", name=\"{}\" }}, fmt(\"{}{}\", {{ {} }})),\n{}",
        {i(1), i(2), i(3), i(4), i(5), i(0)})),
  s({trig = "sns", name = "shared snippet"},
    fmt("M.{} = function ()\n  return fmt(\"{}\", {{ {} }})\nend\n\n{}",
        {i(1), i(2), i(3), i(0)})),
  ...
  s({trig = "s1", name = "one i(n)"}, fmt("i(0)", {})),
  s({trig = "s2", name = "two i(n)"}, fmt("i(1), i(0)", {})),
  s({trig = "s3", name = "three i(n)"}, fmt("i(1), i(2), i(0)", {})),
  s({trig = "s4", name = "four i(n)"}, fmt("i(1), i(2), i(3), i(0)", {})),
  s({trig = "s5", name = "four i(n)"}, fmt("i(1), i(2), i(3), i(4), i(0)", {})),
  s({trig = "s6", name = "four i(n)"},
    fmt("i(1), i(2), i(3), i(4), i(5), i(0)", {})),
  s({trig = "s7", name = "four i(n)"},
    fmt("i(1), i(2), i(3), i(4), i(5), i(6), i(0)", {})),
  s({trig = "s8", name = "four i(n)"},
    fmt("i(1), i(2), i(3), i(4), i(5), i(6), i(7), i(0)", {})),
  s({trig = "s9", name = "four i(n)"},
