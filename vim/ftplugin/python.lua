...
ls.snippets.python = {
  ...
  s({ trig = "va", name = "instance variable assignment" }, fmt("self.{} = {}", { i(1), i(0) })),
  ...
  s({ trig = "lw", name = "log warning" }, fmt("logger.warning({})\n{}", { i(1), i(0) })),
  ...
  s({ trig = "ad", name = "default argument" }, fmt("{} = {},\n{}", { i(1), i(2), i(0) })),
  s({ trig = "atd", name = "typed default argument" }, fmt("{}: {} = {},\n{}", { i(1), i(2), i(3), i(0) })),
  s({ trig = "au", name = "unused argument" }, fmt("del {}  # Explicitly marked as unused\n{}", { i(1), i(0) })),

  s({ trig = "oi", name = "object identifier" }, fmt("__{}__{}", { i(1), i(0) })),
  s({ trig = "om", name = "object method" }, fmt("def __{}__({}):\n    {}\n\n{}", { i(1), i(2), i(3), i(0) })),
  s({ trig = "of", name = "object field" }, fmt('"{}": {}{},\n{}', { i(1), i(2), rep(1), i(0) })),

  s({ trig = "in", name = "named import" }, fmt("from {} import {}\n{}", { i(1), i(2), i(0) })),
  s({ trig = "im", name = "module import" }, fmt("import {}\n{}", { i(1), i(0) })),

  s({ trig = "cw", name = "with statement" }, fmt("with {}:\n    {}", { i(1), i(0) })),
  ...
  s({ trig = "cf", name = "for-each loop" }, fmt("for {} in {}:\n    {}\n\n{}", { i(1), i(2), i(3), i(0) })),
  s({ trig = "cfr", name = "range loop" }, fmt("for {} in range({}):\n    {}\n\n{}", { i(1, "i"), i(2), i(3), i(0) })),

  s({ trig = "et", name = "ternary expression" }, fmt("{} if {} else {}", { i(2), i(1), i(0) })),
  s(
  ...
  s(
    ...
    fmt("[ {} for {} in {} if {}{} ]{}", { rep(2), i(2), i(1), rep(2), i(3), i(0) })
  ),
  s(
    { trig = "er", name = "list comprehension (reduce)" },
    fmt("[ {}{} for {} in {} if {}{} ]{}", { rep(2), i(4), i(2), i(1), rep(2), i(3), i(0) })
  ),
}
